...
public final class WhisperLib {
    ...
    public static native int fullTranscribe(long contextPtr, int numThreads, float[] audioData,
                                            String language, String vadModelPath,
    ...
    public static native int getVadSegmentCount(long contextPtr);
    public static native long getVadSegmentT0(long contextPtr, int index);
    public static native long getVadSegmentT1(long contextPtr, int index);
